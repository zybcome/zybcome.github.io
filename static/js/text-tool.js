    ...
    switch (index) {
        case 0:
            ...
            arrayVal.filter((res, index) => {
                steStr(arrayVal, traditionalized, res, index);
            })
        ...
        case 1:
            // 繁体转简体
            arrayVal.filter((res, index) => {
                steStr(arrayVal, simplized, res, index);
            })
            $("#textarea_val2").val(str);
            $("#textarea_val2").select();
            document.execCommand("copy");
        ...
        case 2:
            // 中文转unicode
            arrayVal.filter((res, index) => {
                steStr(arrayVal, encodeUnicode, res, index);
            })
            $("#textarea_val2").val(str);
            $("#textarea_val2").select();
            document.execCommand("copy");
        ...
        case 3:
            // unicode转中文
            arrayVal.filter((res, index) => {
                steStr(arrayVal, decodeUnicode, res, index);
            })
            $("#textarea_val2").val(str);
            $("#textarea_val2").select();
            document.execCommand("copy");
        ...
        case 4:
            // 简体转繁体转unicode
            arrayVal.filter((res, index) => {
                steStr(arrayVal, encodeUnicode, traditionalized(res), index);
            })
            $("#textarea_val2").val(str);
            $("#textarea_val2").select();
            document.execCommand("copy");
...
function randomString(len) {
    len = len || 32;
    var $chars = 'ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyzoOLlgqVvUuI';    /****默认去掉了容易混淆的字符oOLl,9gq,Vv,Uu,I1****/
